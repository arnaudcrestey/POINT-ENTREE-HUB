            ...
            <section>
              ...
              <div className="relative mt-14 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-6">
                <button
                  ...
                  className={cardClass}
                >
                  <div className="absolute inset-x-0 top-0 h-1 bg-[linear-gradient(90deg,#315f8c,#c8a46b)] opacity-80" />
                  ...
                  <div className="mt-6 flex items-center justify-between border-t border-black/7 pt-4">
                    ...
                    <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[#315f8c]/12 text-[#315f8c] transition-all duration-300 group-hover:translate-x-1 group-hover:bg-[#315f8c] group-hover:text-white">
                      →
                    </span>
                  </div>
                </button>
